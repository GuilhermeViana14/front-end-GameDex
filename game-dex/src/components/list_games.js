...
const ListGames = ({ searchTerm }) => {
  ...
  useEffect(() => {
    ...
    setGames([]);
    setLoading(true);
  }, [checkedPlataformas, checkedGeneros, checkedDevs, searchTerm, bestOfYear]); // ✅ Incluído bestOfYear
  ...
  useEffect(() => {
    ...
    if (bestOfYear) {
      params.append('best_of_year', 'true'); // ✅ Adiciona o filtro na URL
    }
  ...
  }, [page, checkedPlataformas, checkedGeneros, checkedDevs, searchTerm, bestOfYear]); // ✅ Incluído bestOfYear
